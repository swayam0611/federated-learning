...
# ==========================================
    ...
    def fit(self, parameters, config):
        ...
        acc, recall, precision, f1, tp, fp, tn, fn, q0, q1 = evaluate_model(
...
if __name__ == "__main__":
    ...
    CLIENT_ID  = "C2"
    CLIENT_CSV = "/home/coep/Desktop/Local Evaluation_0.1HD/c1/cardio_0_HD_LE_attack_D_M_train_test_attack/clients/custom_splits/output_final/partition1.csv"
